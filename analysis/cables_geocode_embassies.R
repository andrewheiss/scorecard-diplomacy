...
# Original cable data
cables <- read_csv(file.path(PROJHOME, "data", "original", "cables_trafficking.csv"))
...
geocode.cache <- file.path(PROJHOME, "data", "processed", "embassies_geocoded.rds")
...
saveRDS(embassies.final, file.path(PROJHOME, "data", "processed",
                                   "embassies_final.rds"))
