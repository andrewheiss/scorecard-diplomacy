...
source(file.path(PROJHOME, "analysis", "criminalization.R"))
source(file.path(PROJHOME, "analysis", "tier_placements.R"))
source(file.path(PROJHOME, "analysis", "year_joined.R"))
source(file.path(PROJHOME, "analysis", "ratifications.R"))
source(file.path(PROJHOME, "analysis", "funding.R"))
source(file.path(PROJHOME, "analysis", "reactions.R"))
source(file.path(PROJHOME, "analysis", "policy_index.R"))
source(file.path(PROJHOME, "analysis", "cables_tip.R"))
source(file.path(PROJHOME, "analysis", "cases_favorability_influence.R"))
...
width <- 4.5
height <- 5
ggsave(crim.map, filename=file.path(PROJHOME, "output", "figures", 
                                    paste0(filename, ".pdf")), 
...
df.fig3.2 <- read_csv(file.path(PROJHOME, "data", "original",
                                "data_figure3_2.csv")) %>%
...
width <- 4.5
height <- 2.5
ggsave(fig3.2, filename=file.path(PROJHOME, "output", "figures", 
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig3.2, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
width <- 4.5
height <- 2
ggsave(fig.ratified, filename=file.path(PROJHOME, "output", "figures",
                                        paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig.ratified, filename=file.path(PROJHOME, "output", "figures",
                                        paste0(filename, ".png")),
...
width <- 4.5
height <- 2.5
ggsave(tier.plot, filename=file.path(PROJHOME, "output", "figures",
                                     paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(tier.plot, filename=file.path(PROJHOME, "output", "figures",
                                     paste0(filename, ".png")),
...
width <- 4.5
height <- 3.5
ggsave(report.map, filename=file.path(PROJHOME, "output", "figures",
                                      paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(report.map, filename=file.path(PROJHOME, "output", "figures",
                                      paste0(filename, ".png")),
...
df.fig3.8 <- read_csv(file.path(PROJHOME, "data", "original", 
...
df.fig3.8.most <- read_csv(file.path(PROJHOME, "data", "original", 
...
df.fig3.8.active <- read_csv(file.path(PROJHOME, "data", "original", 
                                       "data_figure3_8_active_embassies_plot.csv")) %>%
  mutate(country = factor(country, levels=country, ordered=TRUE))

df.fig3.8.most.active <- read_csv(file.path(PROJHOME, "data", "original", 
...
width <- 4.5
height <- 2
ggsave(fig3.8, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig3.8, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
df.fig3.9 <- read_csv(file.path(PROJHOME, "data", "original",
                                "data_figure3_9.csv")) %>%
...
width <- 4.5
height <- 2
ggsave(fig3.9, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig3.9, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
width <- 4.5
height <- 1.5
ggsave(grants.purpose, filename=file.path(PROJHOME, "output", "figures",
                                          paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(grants.purpose, filename=file.path(PROJHOME, "output", "figures",
                                          paste0(filename, ".png")),
...
width <- 4.5
height <- 3.5
ggsave(map.funding, filename=file.path(PROJHOME, "output", "figures",
                                       paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(map.funding, filename=file.path(PROJHOME, "output", "figures",
                                       paste0(filename, ".png")),
...
df.fig3.12 <- read_csv(file.path(PROJHOME, "data", "original",
                                 "data_figure3_12.csv")) %>%
...
width <- 4.5
height <- 3
ggsave(fig3.12, filename=file.path(PROJHOME, "output", "figures",
                                   paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig3.12, filename=file.path(PROJHOME, "output", "figures",
                                   paste0(filename, ".png")),
...
width <- 4.5
height <- 1.5
ggsave(grants.to.all.sectors, filename=file.path(PROJHOME, "output", "figures",
                                                 paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(grants.to.all.sectors, filename=file.path(PROJHOME, "output", "figures",
                                                 paste0(filename, ".png")),
...
caption <- c("Figure 4.2: Distribution of US Department of State TIP funding across sectors, 2001–2014.",
             "Note: Does not include separate funding through other US agencies or some direct funding of IGOs.",
             "Collapsed sectors:", paste(collapsed.sectors, collapse=", "),
             "Source: US Department of State.") %>%
  paste0(collapse="\n")
cat(caption, file=file.path(PROJHOME, "output", "figures",
                            paste0(filename, ".txt")))
...
width <- 4.5
height <- 1.75
ggsave(grants.to.igos, filename=file.path(PROJHOME, "output", "figures",
                                          paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(grants.to.igos, filename=file.path(PROJHOME, "output", "figures",
                                          paste0(filename, ".png")),
...
caption <- c("Figure 4.3: Distribution of US TIP funding across IGOs and other agencies.",
             "Note: Does not include separate funding through other US agencies or some direct funding of IGOs.",
             "Collapsed IGOs:", paste(collapsed.igos, collapse=", "),
             "Source: US Department of State.") %>%
  paste0(collapse="\n")
cat(caption, file=file.path(PROJHOME, "output", "figures",
                            paste0(filename, ".txt")))
...
df.book.plots <- read_csv(file.path(PROJHOME, "data", "original", "data_figure4_4.csv"))
...
width <- 4.5
height <- 2
ggsave(fig4.4, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig4.4, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
width <- 4.5
height <- 1.75
ggsave(fig4.5, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig4.5, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
df.fig4.6 <- read_csv(file.path(PROJHOME, "data", "original",
                                "data_figure4_6.csv")) %>%
...
width <- 4.5
height <- 2
ggsave(fig4.6, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig4.6, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
df.fig5.2.raw <- read_csv(file.path(PROJHOME, "data", "original",
                                    "data_figure5_2.csv"))
...
width <- 4.5
height <- 3
ggsave(fig5.2, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig5.2, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
width <- 4.5
height <- 4
ggsave(p.reactions, filename=file.path(PROJHOME, "output", "figures",
                                       paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(p.reactions, filename=file.path(PROJHOME, "output", "figures",
                                       paste0(filename, ".png")),
...
df.fig5.5 <- read_csv(file.path(PROJHOME, "data", "original",
                                "data_figure5_5.csv")) %>%
...
width <- 4.5
height <- 4
ggsave(fig5.5, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig5.5, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
df.fig5.7 <- read_csv(file.path(PROJHOME, "data", "original",
                                "data_figure5_7.csv")) %>%
...
width <- 4.5
height <- 3.5
ggsave(fig5.7, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig5.7, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
df.importance.positivity <- read_csv(file.path(PROJHOME, "data", "original",
                                               "data_q3_19_25.csv")) %>%
...
ggsave(combined, 
       filename=file.path(PROJHOME, "output", "figures",
                          paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(combined, 
       filename=file.path(PROJHOME, "output", "figures",
...
df.fig6.3 <- read_csv(file.path(PROJHOME, "data", "original",
                                "data_figure6_3.csv")) %>%
  gather(Variable, num, -Year) %>%
  filter(!is.na(num))
...
width <- 4.5
height <- 2.5
ggsave(fig6.3, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig6.3, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
width <- 5.5
height <- 4.5
ggsave(cho.crim.all.countries, filename=file.path(PROJHOME, "output", "figures",
                                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(cho.crim.all.countries, filename=file.path(PROJHOME, "output", "figures",
                                                  paste0(filename, ".png")),
...
df.fig6.5 <- read_stata(file.path(PROJHOME, "data", "original",
...
df.fig6.5.table <- read_stata(file.path(PROJHOME, "data", "original",
                                        "criminalization_jk_2015-08-10.dta")) %>%
  filter(crimlevel == 2) %>%
  xtabs(~ month, .) %>% print
...
width <- 4.5
height <- 2
ggsave(fig6.5, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig6.5, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
capture.output({
  ...
  print(fig6.5.chisq)
}, file=file.path(PROJHOME, "output", "figures",
                  paste0(filename, "_chisq.txt")))
...
ajps.raw <- read_dta(file.path(PROJHOME, "data", "original",
                               "kelley_simmons_ajps_2014_replication.dta")) %>%
  group_by(cowcode) %>%
...
width <- 4.5
height <- 3
ggsave(fig6.6, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig6.6, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
# Figure and caption generated with `PROJHOME/book_appendix_tables.R`
...
reactions.crim <- read_stata(file.path(PROJHOME, "data", "original",
                                       "reactions_jk_2015-09-18.dta")) %>%
...
width <- 4.5
height <- 3
ggsave(fig6.8, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig6.8, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
width <- 4.5
height <- 6
ggsave(fig.cho.changes, filename=file.path(PROJHOME, "output", "figures",
                                           paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig.cho.changes, filename=file.path(PROJHOME, "output", "figures",
                                           paste0(filename, ".png")),
...
system(sprintf("cp %s %s", 
               file.path(PROJHOME, "output", "figures",
                         paste0(filename.original, ".txt")),
               file.path(PROJHOME, "output", "figures",
                         paste0(filename, ".txt"))))

system(sprintf("cp %s %s", 
               file.path(PROJHOME, "output", "figures",
                         paste0(filename.original, ".png")),
               file.path(PROJHOME, "output", "figures",
                         paste0(filename, ".png"))))

system(sprintf("cp %s %s", 
               file.path(PROJHOME, "output", "figures",
                         paste0(filename.original, ".pdf")),
               file.path(PROJHOME, "output", "figures",
                         paste0(filename, ".pdf"))))
...
width <- 4.5
height <- 3
ggsave(p.cases.favor.influence, filename=file.path(PROJHOME, "output", "figures",
                                                   paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(p.cases.favor.influence, filename=file.path(PROJHOME, "output", "figures",
                                                   paste0(filename, ".png")),
...
source(file.path(PROJHOME, "analysis", "case_study_data_summaries.R"))
...
system(sprintf("cp %s %s", 
               file.path(PROJHOME, "output", "figures", "cases", paste0(filename.original, ".png")),
               file.path(PROJHOME, "output", "figures",
                         paste0(filename, ".png"))))

system(sprintf("cp %s %s", 
               file.path(PROJHOME, "output", "figures", "cases", paste0(filename.original, ".pdf")),
               file.path(PROJHOME, "output", "figures",
                         paste0(filename, ".pdf"))))
...
# Created with code from article repo: 
# https://github.com/andrewheiss/From-the-Trenches-Anti-TIP-NGOs-and-US/commit/3b296d5dc669e43460f151ef328f916d63736c4f
hq.countries <- read_csv(file.path(PROJHOME, "data", "original",
                                   "data_figureA_hq_map.csv"))
...
width <- 4.5
height <- 3.5
ggsave(hq.map, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(hq.map, filename=file.path(PROJHOME, "output", "figures",
                                  paste0(filename, ".png")),
...
# Data also comes from article repo
work.countries <- read_csv(file.path(PROJHOME, "data", "original",
                                     "data_figureA_work_map.csv"))
...
width <- 4.5
height <- 3.5
ggsave(work.map, filename=file.path(PROJHOME, "output", "figures",
                                    paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(work.map, filename=file.path(PROJHOME, "output", "figures",
                                    paste0(filename, ".png")),
...
df.cables.est.year <- read_rds(file.path(PROJHOME, "data", "original",
...
width <- 4.5
height <- 2
ggsave(figA2, filename=file.path(PROJHOME, "output", "figures",
                                 paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(figA2, filename=file.path(PROJHOME, "output", "figures",
                                 paste0(filename, ".png")),
...
width <- 4.5
height <- 4
ggsave(figA3, filename=file.path(PROJHOME, "output", "figures",
                                 paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(figA3, filename=file.path(PROJHOME, "output", "figures",
                                 paste0(filename, ".png")),
...
width <- 4.5
height <- 2.5
ggsave(fig.cho.all.vs.cases, filename=file.path(PROJHOME, "output", "figures",
                                                paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig.cho.all.vs.cases, filename=file.path(PROJHOME, "output", "figures",
                                                paste0(filename, ".png")),
...
# Data generated in book_appendix_tables.R
plot.predict <- read_csv(file.path(PROJHOME, "data", "original",
...
ggsave(fig.media.report, filename=file.path(PROJHOME, "output", "figures",
                                            paste0(filename, ".pdf")), 
       width=width, height=height, device=cairo_pdf)
ggsave(fig.media.report, filename=file.path(PROJHOME, "output", "figures",
                                            paste0(filename, ".png")),
...
plot.predict <- readRDS(file.path(PROJHOME, "data", "original",
